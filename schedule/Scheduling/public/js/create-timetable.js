 ...
 const plugin = (function(){
    ...
    const getItems = () => {
    		...
    		success:function(data){
                ...
                console.log("Lecture: " + allocatedLecturers)
                console.log("UsedVenues: " + usedVenues)
    			...
    			const availableLecturers= availableVenues.map(item => allocatedLecturers.includes(item.id) ? {...item,isLecturersAvailable:false}: {...item,isLecturersAvailable:true})
    			const items = availableLecturers.map(item => allocatedSubjects.includes(item.id) ? {...item,isSubjectAvailable:false}: {...item,isSubjectAvailable:true})
    			const days = {
    ...
    const validate =  data =>{
    	var isValid = false;
    	if(data.isVenueAvailable && data.isLecturersAvailable && data.isSubjectAvailable){
	    	isValid = true
		}
