            ...
            <div class="ibox-content">
                <table class="table table-bordered table-striped myTables">
                  ...
                  <tr class="category_details">
                    <td style="text-align:center" data-id="{{ $category->id }}">
                    <input type="checkbox" name="checkbox" value="{{ $category->id }}">
                    </td>
                    <td>{{ $sn }}</td>
                    <td>{{ $category->name }}</td>
                    <td style="text-align:center"> 
                      <button class="btn edit" data-toggle="modal" data-target="#edit_category" style="background-color: #8CAEC7;">
    ...
    <div class="modal fade" id="edit_category">
        ...
        <script >
            $(function(){
                ...
                deletePlugin.init("{{route('deleteCategory')}}", "Categories", token)
            })
            </script>
@endsection